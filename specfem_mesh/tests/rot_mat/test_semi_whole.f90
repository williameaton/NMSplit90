...
program test_semi_whole
    ...
    integer :: i, j, k,  m1, m2, npoints, knot_lower, knot_upper, nval, lval, nstart, nstop, lstart, lfinish 
    ...
    do nval = nstart, nstop  
        ...
        do lval = lstart, lfinish 
            ...
            mode_1 = get_mode(nval, Tval, lval , mineos_ptr)
            mode_2 = mode_1 !get_mode(nval, 'S', 2 , mineos_ptr)
            ...
            !write(*,*)nval, Tval, lval, bparam*1000.0d0, 
            write(*,*)wcomnondim
