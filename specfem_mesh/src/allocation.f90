module allocation_module
  ...
  interface allocate_if_unallocated
      ...
      module procedure allocate_complex_double_array_1d
      ...
      module procedure allocate_complex_double_array_2d
      ...
      module procedure allocate_complex_double_array_3d
      ...
      module procedure allocate_complex_double_array_4d
      ...
      module procedure allocate_complex_double_array_5d

      module procedure allocate_integer_array_6d
      module procedure allocate_real_array_6d
      module procedure allocate_double_array_6d
      module procedure allocate_complex_array_6d
      module procedure allocate_complex_double_array_6d
  end interface
  ...
  interface deallocate_if_allocated
      ...
      module procedure deallocate_complex_double_array_1d
      ...
      module procedure deallocate_complex_double_array_2d
      ...
      module procedure deallocate_complex_double_array_3d
      ...
      module procedure deallocate_complex_double_array_4d
      ...
      module procedure deallocate_complex_double_array_5d

      module procedure deallocate_integer_array_6d
      module procedure deallocate_real_array_6d
      module procedure deallocate_double_array_6d
      module procedure deallocate_complex_array_6d
      module procedure deallocate_complex_double_array_6d
  end interface
...
contains
  ...
  subroutine allocate_complex_array_1d(n, array)
      integer, intent(in) :: n
      complex(kind=4), allocatable, intent(inout) :: array(:)
      if (.not. allocated(array)) then
        allocate(array(n))
      endif
    ...
    subroutine allocate_complex_double_array_1d(n, array)
      integer, intent(in) :: n
      complex(kind=8), allocatable, intent(inout) :: array(:)
      if (.not. allocated(array)) then
        allocate(array(n))
      endif
    end subroutine allocate_complex_double_array_1d
  ...
  subroutine allocate_complex_array_2d(m, n, array)
    ...
    subroutine allocate_complex_double_array_2d(m, n, array)
      integer, intent(in) :: m, n
      complex(kind=8), allocatable, intent(inout) :: array(:,:)
      if (.not. allocated(array)) then
        allocate(array(m,n))
      endif
    end subroutine allocate_complex_double_array_2d
  ...
  ! ......................... 3D allocation .........................
    ...
    subroutine allocate_complex_double_array_3d(l, m, n, array)
      integer, intent(in) :: l,m, n
      complex(kind=8), allocatable, intent(inout) :: array(:,:,:)
      if (.not. allocated(array)) then
        allocate(array(l,m,n))
      endif
    end subroutine allocate_complex_double_array_3d
  ...
  subroutine allocate_complex_double_array_4d(k, l, m, n, array)
    integer, intent(in) :: k, l, m, n
    complex(kind=8), allocatable, intent(inout) :: array(:, :,:,:)
    if (.not. allocated(array)) then
      allocate(array(k,l,m,n))
    endif
  end subroutine allocate_complex_double_array_4d
  ...
  subroutine allocate_complex_double_array_5d(j, k, l, m, n, array)
    integer, intent(in) :: j, k, l, m, n
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:,:,:)
    if (.not. allocated(array)) then
      allocate(array(j,k,l,m,n))
    endif
  end subroutine allocate_complex_double_array_5d

  ! ......................... 6D allocation .........................

  subroutine allocate_integer_array_6d(i,j,k,l,m,n, array)
    integer, intent(in) :: i,j,k,l,m,n
    integer, allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (.not. allocated(array)) then
      allocate(array(i,j,k,l,m,n))
    endif
  end subroutine allocate_integer_array_6d

  subroutine allocate_real_array_6d(i,j,k,l,m,n, array)
    integer, intent(in) :: i,j,k,l,m,n
    real(kind=4), allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (.not. allocated(array)) then
      allocate(array(i,j,k,l,m,n))
    endif
  end subroutine allocate_real_array_6d

  subroutine allocate_double_array_6d(i,j,k,l,m,n, array)
    integer, intent(in) :: i,j,k,l,m,n
    double precision, allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (.not. allocated(array)) then
      allocate(array(i,j,k,l,m,n))
    endif
  end subroutine allocate_double_array_6d

  subroutine allocate_complex_array_6d(i,j,k,l,m,n, array)
      integer, intent(in) :: i,j,k,l,m,n
      complex(kind=4), allocatable, intent(inout) :: array(:,:,:,:,:,:)
      if (.not. allocated(array)) then
        allocate(array(i,j,k,l,m,n))
      endif
  end subroutine allocate_complex_array_6d

  subroutine allocate_complex_double_array_6d(i,j, k, l, m, n, array)
    integer, intent(in) :: i,j, k, l, m, n
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (.not. allocated(array)) then
      allocate(array(i,j,k,l,m,n))
    endif
  end subroutine allocate_complex_double_array_6d
  ...
  subroutine deallocate_complex_double_array_1d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_1d
  ...
  subroutine deallocate_complex_double_array_2d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_2d
  ...
  subroutine deallocate_complex_double_array_3d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_3d
  ...
  subroutine deallocate_complex_double_array_4d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_4d
  ! ........................ 5D deallocation ........................
  ...
  subroutine deallocate_complex_double_array_5d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_5d

  ! ........................ 6D deallocation ........................

  subroutine deallocate_integer_array_6d(array)
    integer, allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_integer_array_6d

  subroutine deallocate_real_array_6d(array)
    real(kind=4), allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_real_array_6d

  subroutine deallocate_double_array_6d(array)
    double precision, allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_double_array_6d

  subroutine deallocate_complex_array_6d(array)
    complex(kind=4), allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_array_6d

  subroutine deallocate_complex_double_array_6d(array)
    complex(kind=8), allocatable, intent(inout) :: array(:,:,:,:,:,:)
    if (allocated(array)) then
      deallocate(array)
    endif
  end subroutine deallocate_complex_double_array_6d
